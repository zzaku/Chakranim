...
function Identification({ connected, setConnected, setNeedToConnect, wrapperRefLogin }) {
  ...
  return currentUserId ? (
    ...
    <div
      ...
      style={{
        display: "flex",
        height: pathLocation === "connexion" ? "100%" : register ? "75%" : "45%",
        width: pathLocation === "/connexion" ? "100%" : "50%",
    ...
    >
      ...
      {!register ? (
        ...
        <SignUp setRegister={setRegister} pathLocation={pathLocation} setNeedToConnect={setNeedToConnect} />
      )}
    </div>
  );
}

                            ...
                            <h4 style={{color: 'white', margin: "0"}}>Inscription</h4>
                                <div className="form" style={{height:'100%'}}>
                                   <form action=''>
                                        ...
                                        <button disabled={user.password && user.mail && user.tel && user.prenom && user.nom && user.pseudo && user.adresse ? user.password === user.passwordcheck && user.password.length >= 8 && user.mail.match(patternMail) && user.tel.match(patternPhone)  ? false : true : true}  className="float" name="" onClick={(e) => submitInscription(e)}>S'inscrire</button>
                                    </form>
                                </div>

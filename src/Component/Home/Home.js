                ...
                <div className="anime-container">
                    ...
                    <div className="list">
                        <div className="list-container">
                            ...
                            {genre1 && genres[0] ? <List allAnimes={allAnimes} genres={genres[0]} genre={ genre1} setGenre={setGenre1} setNotAtHome={setNotAtHome}/> : null}
                            {genre2 && genres[1] ?<List allAnimes={allAnimes} genres={genres[1]} genre={ genre2} setGenre={setGenre2} setNotAtHome={setNotAtHome}/> : null}
                            ...
                            {genre5 && genres[4] ?<List allAnimes={allAnimes} genres={genres[4]} genre={ genre5} setGenre={setGenre5} setNotAtHome={setNotAtHome}/> : null}
                            {genre6 && genres[5] ?<List allAnimes={allAnimes} genres={genres[5]} genre={ genre6} setGenre={setGenre6} setNotAtHome={setNotAtHome}/> : null}
                            {genre7 && genres[6] ?<List allAnimes={allAnimes} genres={genres[6]} genre={ genre7} setGenre={setGenre7} setNotAtHome={setNotAtHome}/> : null}
                            ...
                            {genre10 && genres[9] ?<List allAnimes={allAnimes} genres={genres[9]} genre={ genre10} setGenre={setGenre10} setNotAtHome={setNotAtHome}/> : null}
